...
import { handleRequestGet, handleRequestPost } from 'wildebeest/functions/api/wb/settings/server/rules'
...
export const ruleLoader = loader$<Promise<{ id: number; text: string }>, { DATABASE: D1Database }>(
	async ({ params, platform, html }) => {
